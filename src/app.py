...
activities = {
    ...
    "Basketball Club": {
        "description": "Learn basketball skills, drills, and play friendly games",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["jake@mergington.edu", "nina@mergington.edu"]
    },
    "Art Club": {
    ...
    "Science Olympiad": {
        "description": "Study science concepts and compete in science challenges",
